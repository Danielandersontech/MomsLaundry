    ...
    <div class="card-body">  
        <form action="/admin/order" method="POST">  
            ...
            <div class="form-group mt-3">  
                ...
                <select name="id_package" class="form-control select2" data-placeholder="Cari Nama Paket..." style="width: 100%">  
            ...
            <div class="form-group mt-3">  
                ...
                <input type="datetime-local" name="waktu_pengambilan" class="form-control" value="{{ old('waktu_pengambilan') }}">  
                <span class="text-danger">{{ $errors->first('waktu_pengambilan') }}</span>  
            </div>  
  
            <div class="form-group mt-3">  
                <label for="waktu_pengantaran">Waktu Pengantaran</label>  
                <input type="datetime-local" name="waktu_pengantaran" class="form-control" value="{{ old('waktu_pengantaran') }}">  
